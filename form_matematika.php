...
<head>
    ...
    <title>Form_Matematika</title>
</head>

<body>
    <table width="800 border=" 1" align="center" cellpadding="0" cellspacing="0" bgcolor="#000" style="padding: 2px">
        <form>
            <td align="center" bgcolor="yellow" <font color="#000000">
                <div class="container">
                    <div class="row mb-2">
